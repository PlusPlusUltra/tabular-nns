...
def get_classical_args():
    ...
    parser.add_argument('--remove_outliers', action='store_true', help='Enable outlier filtering')
    parser.add_argument('--outlier_method', type=str, default='IsolationForest',
                    choices=['IsolationForest', 'LocalOutlierFactor', 'OneClassSVM', 'ZScore', 'ModifiedZScore', 'IQR'],
